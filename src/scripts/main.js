...
toSellOrNotToSell(firedOrangeMug)
toSellOrNotToSell(firedPiggyBank)
toSellOrNotToSell(firedFrogVase)
toSellOrNotToSell(firedTeaPot)
toSellOrNotToSell(firedTerracottaPot)
